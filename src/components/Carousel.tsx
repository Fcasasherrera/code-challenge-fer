  ...
  return (
    <>
            ...
            <Carousel dotPosition="top" autoplay>
                <div className="wrapper">
                    <div className="splash_image">
                        <img src="http://fc07.deviantart.net/fs34/f/2008/290/6/4/Large_Tree_Stock_by_HauntingVisionsStock.jpg" alt="message" />
        ...
        :
            <Carousel dotPosition="top" autoplay>
                <Card
                    cover={<img alt="makeup" className="img" src="https://images-na.ssl-images-amazon.com/images/I/817pDGib6QL._AC_SL1500_.jpg" />}
                >
